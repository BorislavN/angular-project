...
offersRouter.get("/:offerId/comments",
    commentController.getAllComments);//all comments for offer //DONE

offersRouter.post("/:offerId/comments",
    authUser(),
    commentValidation,
    checkForErrors,
    commentController.addComment);//add comment to offer //AUTH// //DONE

offersRouter.get("/:offerId",
    offerController.getOffer);//offer details //DONE

offersRouter.put("/:offerId",
    authUser(),
    offerValidation,
    checkForErrors,
    offerController.editOffer);//edit offer //AUTH// //DONE

offersRouter.delete("/:offerId",
    authUser(),
    offerController.deleteOffer);//remove offer //AUTH// //DONE
...
offersRouter.post("/",
    ...
    offerValidation,
    checkForErrors,
    offerController.addOffer);//add an offer //AUTH// //DONE
